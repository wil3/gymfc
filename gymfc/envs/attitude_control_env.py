...
class AttitudeControlEnv(GazeboEnv):
    def __init__(self, world="attitude-iris.world", 
        ...
        super(AttitudeControlEnv, self).__init__(motor_count = motor_count, world=world)
...
class AttitudeContinuousControlEnv(AttitudeControlEnv):
    def __init__(self, command_time_off=[], command_time_on=[], **kwargs):
        ...
        super(AttitudeContinuousControlEnv, self).__init__(**kwargs)
